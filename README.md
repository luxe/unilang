...
The reason that parsing errors are often confusing and unhelpful, is because multiple lexemes are necessary to understand
the user's intentions around the programming concepts, and with a single incorrect lexeme, we can't partially construct their intentions.
