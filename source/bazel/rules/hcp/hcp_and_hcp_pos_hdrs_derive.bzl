...
def hcp_and_hcp_pos_hdrs_derive(
        ...
        deps = [],
        data = []):
    hcp_hdrs_derive(name, interface_hdrs, implementation_hdrs, interface_deps, implementation_deps, deps, data)
    hcp_pos_hdrs_derive(name, interface_hdrs, implementation_hdrs, interface_deps, implementation_deps, deps, data)
