...
def hcp_pos_hdrs_derive_specific(
        name,
        hcp_name,  #filename
        hpp_name,  #filename
        cpp_name,  #filename
    ...
    native.genrule(
        ...
        tools = ["//code/programs/transcompilers/hcp-compiler/official_pos_hdrs_derive:hcp-compiler"],
        cmd = "$(location //code/programs/transcompilers/hcp-compiler/official_pos_hdrs_derive:hcp-compiler) --input_files $(SRCS) -o $(@D) --output-base-name {} {} {} {} {}"
