...
void
extend(GLfloat new_array[3], GLfloat light[3], GLfloat vertex[3], GLfloat t)
{
  GLfloat delta[3];
  ...
  new_array[X] = light[X] + delta[X] * t;
  new_array[Y] = light[Y] + delta[Y] * t;
  new_array[Z] = light[Z] + delta[Z] * t;
}
