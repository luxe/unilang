...
faceinit ( void )
{
  face = create_face         ( "code/hello_world/glut/geoface/index.dat", "code/hello_world/glut/geoface/faceline.dat") ;
  read_muscles               ("code/hello_world/glut/geoface/muscle.dat", face ) ;
  read_expression_vectors    ("code/hello_world/glut/geoface/expression-vectors.dat", face ) ;
  data_struct                ( face ) ;	
}
