...
button_t create_button(obj_type otype, char *label, int x, int y, fptr_t *click_callback) {
  ...
  b = (button_t){window_id, otype, "", static_cast<char>(origin), static_cast<char>(width), static_cast<char>(height), 0, {0,0},{static_cast<uint32_t>(x),static_cast<uint32_t>(y)}, click_callback};
