...
void Write_Each_Line_Of_Vector_Into_File(std::vector<std::string> const& vec, std::string const& file);void Write_Each_Line_Of_Vector_Into_File(std::vector<std::string> const& vec, std::string const& file);
