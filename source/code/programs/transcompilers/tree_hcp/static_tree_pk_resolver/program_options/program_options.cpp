...
boost::program_options::options_description Program_Options::Get_Options_Description(void){
	...
	//Program Description
	options_description desc("creates logic for pk lookups that create variants based on tree and reference data");
	...
	("input_file,i",value<std::vector<std::string>>(),"input file")
...
std::vector<std::string> Program_Options::Input_File() const{
	std::vector<std::string> data;
	if (vm.count("input_file")){
		data = vm["input_file"].as<std::vector<std::string>>();
	}
