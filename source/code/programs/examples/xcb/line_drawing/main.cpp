...
void event_loop() {
  ...
  while ((e = xcb_wait_for_event (c))) {
    ...
    3. draw line from line_start to mouse_pos
      */
      xcb_clear_area(c, 1, win,0, 0, 500,500);
      xcb_point_t mouse_pos = { static_cast<int16_t>(ev->event_x - line_start.x), static_cast<int16_t>(ev->event_y - line_start.y)} ;
    ...
    case XCB_BUTTON_RELEASE: {
      ...
      line_end = (xcb_point_t){ static_cast<int16_t>(ev->event_x - line_start.x), static_cast<int16_t>(ev->event_y - line_start.y) };
