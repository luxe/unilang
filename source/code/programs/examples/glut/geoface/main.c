...
faceinit ( void )
{
  face = create_face         ( "code/programs/examples/glut/geoface/index.dat", "code/programs/examples/glut/geoface/faceline.dat") ;
  read_muscles               ("code/programs/examples/glut/geoface/muscle.dat", face ) ;
  read_expression_vectors    ("code/programs/examples/glut/geoface/expression-vectors.dat", face ) ;
  data_struct                ( face ) ;	
}
