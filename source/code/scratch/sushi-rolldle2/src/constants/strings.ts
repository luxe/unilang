...
export const NOT_ENOUGH_LETTERS_MESSAGE = 'Feed me more letters!'
...
export const GUESS_DISTRIBUTION_TEXT = 'Meal Distribution'
export const NEW_WORD_TEXT = 'New meal in'
export const SHARE_TEXT = 'Share'
export const TOTAL_TRIES_TEXT = 'Total meals'
export const SUCCESS_RATE_TEXT = 'Full stomach'
