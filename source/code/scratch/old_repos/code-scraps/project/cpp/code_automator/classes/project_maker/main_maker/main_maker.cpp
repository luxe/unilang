...
void Main_Maker::Create_Main_Folder(std::string const& main_folder,std::string const& main_module_name){
	...
	//-------------//
		...
		Code_Paster::Put_Main_Module_DR_Rules_File(main_folder +"main/direct_relationships/.Rules.mk");
		...
		Code_Paster::Put_Main_Function_File(main_folder + "main/main_parts/main_function.hpp");
		...
		//add the Rules and Makefile
		Code_Paster::Put_Main_Module_Rules_File(main_folder +"main/.Rules.mk",main_module_name);
		Make_Putter::Hard_Link_The_Makefile(main_folder + "main/");
		
		
	return;
}
void Main_Maker::Build_Include_Portion(std::string const& path, std::string const& includes_file){
