...
const std::string Program_Options::VERSION_NUMBER = "2.0.0";
...
boost::program_options::options_description Program_Options::Get_Options_Description(void){
	...
	("inclusion_guards","use inclusion gaurds over pragma once. [will be use pragma once by default]\n")
