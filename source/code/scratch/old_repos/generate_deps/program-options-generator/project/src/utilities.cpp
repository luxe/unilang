...
std::vector<std::vector<std::string>> Convert_Vector_Of_Strings_To_Vector_Of_Vectors(std::vector<std::string> const& vec_of_strings) {
	std::vector<std::vector<std::string>> return_vec;

	std::string str;
	std::vector<std::string> vec;
	for (auto const& it: vec_of_strings) {
