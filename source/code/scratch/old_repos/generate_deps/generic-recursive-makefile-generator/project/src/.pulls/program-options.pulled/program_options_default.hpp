...
class Program_Options_Default{
	...
	"creates a generic recursive makefile based on input flag data"
	;
	
	//website to get code and further information about the software
	// (applied by the flag value --website)
	const std::string WEBSITE =
	"https://github.com/generative-dependencies/generic-makefile-generator"
	;
	...
	"generic-recursive-makefile-generator"
	;
