...
class Program_Options: public Program_Options_Default{
	...
	//| USER FLAGS                                               |
	//+----------------------------------------------------------+
	/* false */ bool All()const; //add all important system headers;
	/* false */ bool Std()const; //add all important std library headers;
	/* false */ bool Boost()const; //add all important boost library headers;
	/* false */ bool Qt()const; //add all important Qt library headers;
	/* false */ bool Ncurses()const; //add all important ncurses library headers;
	/*  */ std::vector<std::string> Adds()const; //add additional include statements;
	/*  */ std::vector<std::string> Removes()const; //add additional include statements to NOT include;
