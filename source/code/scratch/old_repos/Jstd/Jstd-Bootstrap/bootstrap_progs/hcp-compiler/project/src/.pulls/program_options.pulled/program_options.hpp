...
class Program_Options: public Program_Options_Default{
	...
	//| USER FLAGS                                               |
	//+----------------------------------------------------------+
	/*  */ std::vector<std::string> Input_Files()const; //the url of the repository to download;
	/* false */ bool Optimize()const; //optimize the hcp file on dependencies while compiling;
