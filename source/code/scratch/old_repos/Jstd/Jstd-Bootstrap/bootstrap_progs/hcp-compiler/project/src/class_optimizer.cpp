...
//also has to call make to make sure the changes are valid, so it also compiles the hcp as well as the c++ to create a .o
 void Class_Optimizer::Optimize_HCP_File(Class_Structure structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Initial_Test(Class_Structure const& structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Sort_And_Remove_Duplicates_Test(Class_Structure & structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Remove_Sources_Based_On_Headers_Test(Class_Structure & structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Move_As_Many_Includes_From_Header_To_Source_Test(Class_Structure & structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Try_Raw_Deletes(std::vector<std::pair<std::wstring,bool>> & includes, Class_Structure & structure, std::string const& hcp_file){
 ...
 void Class_Optimizer::Reprint_Hcp_File(Class_Structure const& structure, std::string const& hcp_file){
 ...
 bool Class_Optimizer::Compiles(Class_Structure const& structure, std::string hcp_file){
