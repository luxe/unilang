...
void Class_Structure_Creator::Process_Character_Expecting_Header_Include(Class_Structure & structure){
    ...
    if (c == L'❪'){current_state=Structure_State::IN_HEADER_INCLUDE;}
        ...
        Error_On_These_Other_Characters(L"while expecting header include",{L'❫',L'⚞',L'⚟',L'☀',L'◈',L'◀',L'▶',L'◖',L'◗',L'❰',L'❱',L'፠'});
...
void Class_Structure_Creator::Process_Character_Expecting_Source_Include(Class_Structure & structure){
    ...
    if (c == L'❪'){current_state=Structure_State::IN_SOURCE_INCLUDE;}
        ...
        Error_On_These_Other_Characters(L"while expecting a source include",{L'❫',L'⚯',L'⚟',L'☀',L'◈',L'◀',L'▶',L'◖',L'◗',L'❰',L'❱',L'፠'});
        structure.Add_Character_To_Both_HPP_and_CPP(c);
    }
...
void Class_Structure_Creator::Process_Character_In_Source_Include(Class_Structure & structure){
    ...
    if (c == L'❫'){
        ...
        Error_On_These_Other_Characters(L"in a source include block",{L'❪',L'⚯',L'⚞',L'⚟',L'☀',L'◈',L'◀',L'▶',L'◖',L'◗',L'❰',L'❱',L'፠'});
        include_name_temp+= c;
    }
...
void Class_Structure_Creator::Process_Character_In_Inheritance(Class_Structure & structure){
    ...
    if (c == L'⚟'){
        ...
        auto str = Make_Capital_And_Underscored_In_User_Type_Format(As_Removed_Suffix(Class_Compiler::hack_fix(file_name,true)));
        std::wstring wstr(str.begin(),str.end());
        structure.Add_String_To_Inheritance(wstr);
    }
    else{
        Error_On_These_Other_Characters(L"while in an inheritance block",{L'❪',L'❫',L'⚯',L'⚞',L'☀',L'◀',L'▶',L'◖',L'◗',L'❰',L'❱',L'፠'});
...
void Class_Structure_Creator::Process_Character_Expecting_Anything(Class_Structure & structure){
    ...
    if(c == L'◀'){
        ...
        Error_On_These_Other_Characters(L"while not in a Unicode block",{L'❪',L'❫',L'⚯',L'⚞',L'⚟',L'▶',L'◗',L'❱',L'፠'});
        structure.Add_Character_To_Both_HPP_and_CPP(c);
    }
...
void Class_Structure_Creator::Process_Character_In_Data_Member(Class_Structure & structure){
    if (c == L'፠'){
        ...
        structure.Add_String_To_HPP_Code(data_member_name_temp);
...
void Class_Structure_Creator::Process_Character_In_CPP_Only(Class_Structure & structure){
    ...
    if (c == L'◗'){
        ...
        Error_On_These_Other_Characters(L"while in cpp only block",{L'❪',L'❫',L'⚯',L'⚞',L'⚟',L'☀',L'◀',L'▶',L'◖',L'❰',L'❱',L'፠'});
...
void Class_Structure_Creator::Process_Character_In_Function_Body(Class_Structure & structure){
    ...
    if(c == L'❱'){
        ...
        Error_On_These_Other_Characters(L"while in header a include block",{L'❪',L'❫',L'⚯',L'⚞',L'⚟',L'☀',L'◈',L'◀',L'▶',L'◖',L'◗',L'❰',L'፠'});
        structure.Add_Character_To_CPP_Code(c);
    }
    return;
}
void Class_Structure_Creator::Handle_Escaped_Character(Class_Structure & structure){
    ...
    if (c != All_Of(L'❪',L'❫',L'⚯',L'⚞',L'⚟',L'☀',L'◈',L'◀',L'▶',L'◖',L'◗',L'❰',L'❱',L'ļ',L'ͼ',L'ͽ',L'፠')){
...
//utility
void Class_Structure_Creator::Error_On_These_Other_Characters(std::wstring const& doing, std::vector<wchar_t> others){
